...
_MPMODELPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='general_constraint', full_name='operations_research.MPModelProto.general_constraint', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='operations_research.MPModelProto.name', index=5,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='solution_hint', full_name='operations_research.MPModelProto.solution_hint', index=6,
...
MPGeneralConstraintProto = _reflection.GeneratedProtocolMessageType('MPGeneralConstraintProto', (_message.Message,), dict(
...
MPIndicatorConstraint = _reflection.GeneratedProtocolMessageType('MPIndicatorConstraint', (_message.Message,), dict(
