...
class RoutingModel(object):
    ...
    def MakePathSlacks(self, dimension: 'RoutingDimension', total_slacks: 'std::vector< operations_research::IntVar * >') -> "operations_research::Constraint *":
    ...
    def PackCumulsOfGlobalOptimizerDimensionsFromAssignment(self, original_assignment: 'Assignment', duration_limit: 'absl::Duration') -> "operations_research::Assignment const *":
...
class RoutingDimension(object):
    ...
    def GetGroupDelay(self, vehicle: 'int', from_index: 'int64', to_index: 'int64') -> "int64":
